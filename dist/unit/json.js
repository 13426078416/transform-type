      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _context.next = 5;
            return (0, _jsonSchemaToTypescript.compile)(jsonSchema, fakeTypeName, _config.JSTTOptions);
...
function dataTypeGenerator(json) {
  ...
  return _prettier2.default.format(params, _config.defaultPrettierConfig);
}
